...
pred_path="${SCRATCH}/models/STIC/results/cvqa_llavanextvideo_responses.jsonl"
# output_dir="${GPT_Zero_Shot_QA}/MSRVTT_Zero_Shot_QA/${output_name}/gpt"
output_json="${SCRATCH}/models/STIC/results/eval/results_causalvidqa_llavanextvideo_${type}.json"
