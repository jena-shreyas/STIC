...
DATA_PATH="outputs/FineVideo/frame_swapping_pref_new.json"
# IMAGE_FOLDER="${SCRATCH}/datasets/COCO/pref_images"/
VIDEO_FOLDER="${SCRATCH}/datasets/FineVideo/videos"
...
MID_RUN_NAME="llavanextvideo7b_dpo_temporal_frame_swapping"
wandb online
